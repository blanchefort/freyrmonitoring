...
class VKParser:
    ...
    def latest_posts(self, point: str = '', domain: bool = True) -> List:
    ...
    def post_comments(self, owner_id: int, post_id: int) -> List:
    ...
    def users(self, user_ids: List) -> List:
    ...
    def group_info_by_url(self, link: str) -> Dict:
